...
const ratingUpdate = (start, end, active) => {
  for (let i = start; i <= end; i++) {
    if (active) {
      ...
      starContainer[i].firstElementChild.className = "fas fa-star";
    } else {
     
      starContainer[i].classList.remove("active");
      starContainer[i].classList.add("inactive");
      starContainer[i].firstElementChild.className = "far fa-star";
    }
  }
  //Message
  ...
  if (activeElements.length > 0) {
    switch (activeElements.length) {
      case 1:
        message.innerText = "Tệ";
        break;
      case 2:
        message.innerText = "Trung bình";
        break;
      case 3:
        message.innerText = "Khá";
        break;
      case 4:
        message.innerText = "Tốt";
        break;
      case 5:
        message.innerText = "Xuất sắc";
        break;
    }
  } else {
    message.innerText = "";
