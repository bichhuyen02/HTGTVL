...
import com.htran.filters.CustomAccessDeniedHandler;
import com.htran.filters.JwtAuthenticationTokenFilter;
import com.htran.filters.RestAuthenticationEntryPoint;
...
//        http.authorizeRequests().antMatchers("/api/jobs/**").permitAll();
        http.authorizeRequests().antMatchers("/api/companies/").permitAll();
//        http.authorizeRequests().antMatchers("/api/companies/**").permitAll();
